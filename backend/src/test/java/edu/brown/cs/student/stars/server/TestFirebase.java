...
public class TestFirebase {
    ...
    public void testUpdateOnNonExistentUser() {
        assertEquals("User, nonexistentusertest, does not exist under that root", firebase.updateDatabase(root, "nonexistentusertest", "doesn't matter what's here"));
    }

    @Test
    public void testDeleteOnNonExistentUser() throws URISyntaxException, IOException, InterruptedException {
        assertEquals("User, nonexistentusertest, does not exist under that root", firebase.deleteFromDatabase(root, "nonexistentusertest"));
    }
    ...
    public void testValidPutDatabase() throws URISyntaxException, IOException, InterruptedException {
        firebase.putDatabase(root, mainUser.getEmailWithoutEdu(), firebase.createNewUser(mainUser));
    ...
    public void testValidUpdate() throws URISyntaxException, IOException, InterruptedException {
        assertEquals("Latch", firebase.updateDatabase(root, "tommy", "updateValue"));
    ...
    public void testValidDeleteFromDatabase() throws URISyntaxException, IOException, InterruptedException {
        ...
        assertEquals("Latch", firebase.deleteFromDatabase(root2, "tommy"));
    ...
    public void testInvalidPut() throws IOException {
        firebase.initFirebase();
        assertEquals("Please do not use forbidden chars in the key", firebase.putDatabase(root, "invalidchar.here", "N/A"));
    }
